...
- НЕ питай клієнта про терміни самостійно — це зайве питання
- Якщо клієнт САМ каже що йому потрібно за певний період — зафіксуй це і скажи що точні терміни залежать від об'єму замовлення та завантаженості виробництва, менеджер зорієнтує
- Якщо клієнт надіслав проект/ескіз — об'єм вже зрозумілий з проекту, не потрібно окремо уточнювати
